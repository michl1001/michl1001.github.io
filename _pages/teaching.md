...
This course is design to guide students through the important choices and challenges of deploying an IoT network for a MVP that is expected to scale to millions of devices. We identify the trade offs between various networking technologies (BLE, Wifi, LoRa, IoT-Cellular, etc.)
Credit: [https://ese5180.seas.upenn.edu/](https://ese5180.seas.upenn.edu/)

### Main Contributions
- Developed Course Assignments and Infastructure up to and including setting up Nordic development examples to demonstate the principles of Wifi, BLE, and Cellular board development. Developed assignments for Lora communication  Held discussion sections and guided students through the process of developing a working IoT network.
